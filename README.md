...
Recent McGill University graduate in Statistics and Computer Science with a strong foundation in data engineering, analytics, software development, and problem-solving. Certified in IBM Data Engineering and Snowflake Data Engineering, with hands-on experience building and supporting scalable end-to-end data pipelines using Databricks, PySpark, Delta Live Tables (DLT), SQL, Python, Azure, and Medallion Architecture. Highly motivated to continuously learn and adopt emerging technologies that improve data reliability, performance, and business impact. Known for strong communication skills, analytical thinking, and a collaborative mindset, with a genuine enthusiasm for working directly with stakeholders to translate complex business requirements into practical, high-quality technical solutions. Well-suited for technical consulting and data engineering environments that demand both engineering rigor and client-facing excellence.
...
**Core Java Apps** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_AlanHu/tree/master/core_java)]:
  ...
  - Twitter App: Placeholder to allow profile_app.sh to work.
  - JDBC App: Placeholder to allow profile_app.sh to work.
...
**Databricks Bullhorn CRM Pipeline**: Maintained and enhanced enterprise ETL pipelines in Databricks using PySpark, Delta Live Tables (DLT), and Medallion Architecture (Bronze, Silver, Gold) to ingest, transform, and curate CRM data for downstream reporting and analytics. Developed REST API-based ingestion workflows using token authentication, orchestrated tier-specific pipelines through centralized Databricks Jobs, and implemented testing pipelines and validation checks to ensure data quality, code reliability, and production readiness.
...
**Data Engineer/Jr Technical Instructor, Jarvis (Nov 2025 - Present)**: Engineered and maintained end-to-end data solutions across software development and data engineering initiatives, leveraging Databricks, PySpark, Delta Live Tables (DLT), and Medallion Architecture to build scalable ETL pipelines and transform CRM and operational data into analytics-ready datasets. Developed backend applications and automation tools using Java, Python, Bash, PostgreSQL, Docker, and Git, while supporting trainee development through the delivery and enhancement of technical training modules, mentorship, and candidate assessments.
